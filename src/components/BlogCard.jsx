...
const BlogCard = ({ blog, handleAddToBookmarks, handleSpentTimeOnRead, handleRemoveToBookmarks }) => {
    ...
    const handleBookmarkRemoveClick = (id) => {
        handleRemoveToBookmarks(id);
        ...
        <div className="w-full">
            ...
            <div className="w-full flex justify-between pt-[2rem]">
                ...
                <div className="flex items-center">
                    ...
                    {isBookmarked ? (
                        <MdOutlineBookmark
                            onClick={() => handleBookmarkRemoveClick(blog.id)}
